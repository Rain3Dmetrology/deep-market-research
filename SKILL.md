...
> - **行业赛道模式**：查询含"行业/赛道/产业链/投资机会/趋势预测/商业化落地/市场规模"-> 模板 B，强制利润穿透、反方观点、1-2 年趋势、每板块>=1非散文元素。
> - **公司/竞品模式**：查询含"公司/竞品/尽调/扒一下/挖一下/对位/对标"-> 模板 C，强制四维分析、7字段证据、SWOT、情景推演、真实负面多渠道验证。
> - **学术/基准/技术选型/尽调模式**：查询含"论文/SOTA/学术/基准/技术选型/文献综述"-> 模板 D，启用学术数据源模块与严格引文格式。
