...
> 本示例的用户口碑信号（小红书 / 脉脉）已在 Step 1 经 agent-reach 兜底采集，按 T4 信号在 Step 3 分级标注、与硬事实分离，故不再单独开一轮。

**Step 7 -- 综合评分**

> 评分卡：证据强度 A-，覆盖度 B+，矛盾 1 处已标注。

**Step 8 -- 结构化输出（模板渲染，B + C 叠加）**
